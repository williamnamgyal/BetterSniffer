...
class sniffingThread(threading.Thread):
    ...
    def run(self):
        ...
        #stop
            ...
            self.my_tree.insert("", 'end', iid=self.iteration_var_1, values=(self.iteration_var_1, packet_src, packet_dst, packet_protocol, packet_length))
...
def open_command():
    ...
    my_tree['columns'] = ("No.", "Source", "Destination", "Protocol", "Length")
    ...
    for packet in scapy_cap:
        ...
        my_tree.insert("", 'end', iid=blahi, values=(blahi, packet_src, packet_dst, packet_protocol, packet_length))
        blahi=blahi+1
        packets_list_storage.append(packet)
...
root = Tk()
root.title("BetterSniffer Network Analysis Tool")
